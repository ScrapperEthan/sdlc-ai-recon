...
- **2026-07-02** — Step 2 scaffolding pilot (spec-driven, delivered via Codex):
  ...
  - **P2.1** — copied platform/API files sanitized: inherited governance/account/branch/URL/email values (incl. JSON `api.meta`) blanked to `<REVIEW>` and listed in `REVIEW_DIFF.md` (`docs/specs/scaffolding-p2-sanitize.md`). Verified on real mirror.
